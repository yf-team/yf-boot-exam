...
public class RepoQuController extends BaseController {
    ...
    */
    ...
    public ApiRest<?> save(@RequestBody RepoQuReqDTO reqDTO) {
    ...
    */
    ...
    @PostMapping("/detail")
    public ApiRest<RepoQuReqDTO> detail(@RequestBody BaseIdReqDTO reqDTO) {
        RepoQuReqDTO dto = repoQuService.detail(reqDTO.getId());
